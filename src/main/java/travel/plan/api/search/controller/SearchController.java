...
public class SearchController {
    ...
    public List<SearchPuzzleDTO> searchArea(@RequestParam String searchText) throws Exception {
    ...
    public void searchPuzzle(SearchPuzzleDTO searchPuzzle) throws Exception {

    }

    @Operation(summary = "위치기반관광정보검색", description = "TODO")
    @RequestMapping(value = "/searchLocation", method = RequestMethod.GET)
    public List<SearchDetailDTO> searchLocation(SearchLocationDTO searchLocation) throws Exception {
